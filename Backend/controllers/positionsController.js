...
exports.getPositions = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: error.message || 'Error fetching positions',
      });
  }
};
...
exports.deletePosition = async (req, res) => {
  try {
    ...
    if (assigned) {
      return res
        ...
        .json({
          success: false,
          message:
            'Cannot delete position: one or more users are assigned to it',
        });
    }
    await pos.remove();
    ...
    res
      ...
      .json({
        success: false,
        message: error.message || 'Error deleting position',
      });
  }
};
