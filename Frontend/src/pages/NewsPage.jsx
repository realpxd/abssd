  ...
  const allNews = data?.data || [
    {
      ...
      date: '2024-02-15',
      description:
        'फाल्गुन मेले के दस दिवसीय विशेष सफाई अभियान का सफलतापूर्वक संचालन किया गया।',
      imageUrl:
    ...
    },
    {
      ...
      date: '2024-01-20',
      description:
        'हर माह की एकादशी सेवा कार्यक्रम में 500+ स्वयंसेवकों ने भाग लिया।',
      imageUrl:
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              हमारे कार्यक्रमों, अभियानों और गतिविधियों के बारे में नवीनतम
              समाचार
              <br />
