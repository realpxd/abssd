...
const MajorMembers = ({ lowHeight }) => {
  return (
    <div
      className={`bg-gradient-to-b from-orange-50 via-white to-orange-50 pt-16 pb-16 md:pb-0 ${lowHeight ? 'min-h-[50vh]' : 'min-h-[70vh]'}`}
    >
      {!lowHeight && (
        <SEO
      ...
      <div className='container mx-auto px-4'>
        <div className='max-w-3xl mx-auto text-center mb-12'>
          ...
          <p className='mt-3 text-gray-600'>
            हमारे ट्रस्ट और इसके मिशन का मार्गदर्शन करने वाली प्रमुख टीम से
            मिलें
          </p>
          <p className='mt-1 text-gray-600'>
            Meet the core team guiding our trust and its mission
          </p>
        </div>
