...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        res.message || 'Password reset successful. You may now log in.',
      );
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50'>
      <SEO
        ...
        description='अपने खाते के लिए नया पासवर्ड सेट करें। अपने ईमेल से प्राप्त रीसेट टोकन का उपयोग करें।'
        ...
        <div className='max-w-md w-full'>
          <div className='bg-white rounded-2xl shadow-xl overflow-hidden'>
                ...
                <div className='w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border-4 border-white/30'>
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d='M12 11c0-1.657-1.343-3-3-3S6 9.343 6 11s1.343 3 3 3 3-1.343 3-3zM21 12v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6'
                    />
                  </svg>
                </div>
              </div>
            ...
            <div className='px-8 py-8'>
              ...
              <div className='mt-6 text-center'>
                ...
                >
                  कृपया एक नया अनुरोध भेजें / Request a new link
                </Link>
              </div>
            </div>
          </div>
          <div className='mt-6 text-center'>
            <p className='text-xs text-gray-500'>
              Secure password reset / ABSSD Trust
            </p>
          </div>
        </div>
      </div>
