      ...
      <div className='container mx-auto px-4'>
        <div className='max-w-6xl mx-auto'>
            ...
            <div className='bg-white rounded-lg shadow-lg p-8'>
              {user.membershipStatus && user.membershipStatus === 'pending' && (
                <div className='mb-6 p-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 rounded'>
                  <p className='mb-4'>
                    आपका सदस्यता आवेदन प्रक्रिया में है। कृपया कुछ समय प्रतीक्षा
                    करें या समर्थन से संपर्क करें।
                  </p>
                  <button
                    onClick={() => {
                      ...
                      window.open(
                        `https://wa.me/8860442044?text=${encodeURIComponent(message)}`,
                        '_blank',
                      );
                    }}
              ...
              <div className='flex flex-col md:flex-row gap-6'>
                ...
                <div className='md:w-[380px]'>
                  <IDCard
                    ...
                    watermarkText='sample sample sample sample sample sample sample sample sample sample sample'
                  />
                </div>
              ...
              {photoFile && (
                <div className='mt-6 p-4 bg-gray-50 rounded-lg'>
                  <p className='text-sm text-gray-600 mb-3'>
                    New photo selected. Click below to upload.
                  </p>
                  <button
            ...
            <div className='bg-white rounded-lg shadow-lg p-8'>
              <div className='flex justify-between items-center mb-6'>
                <h2 className='text-2xl font-bold'>
                  व्यक्तिगत सेटिंग्स / Personal Settings
                </h2>
                {!editMode && (
                  <button
          ...
          {activeTab === 'notifications' && (
            <div className='bg-white rounded-lg shadow-lg p-8'>
              <h2 className='text-2xl font-bold mb-6'>
                सूचनाएं और ईमेल / Notifications & Emails
              </h2>
              <div className='space-y-4'>
