      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed'>
            ...
            <br />
            <br />
            Your contribution plays a vital role in our social service
            initiatives.
            <br />
            Your contribution is exempt from tax under section 80G/12A of the
            Income Tax Act.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 gap-8 max-w-6xl mx-auto'>
          ...
          <div className='bg-white rounded-2xl shadow-xl p-8 border-t-4 border-orange-600'>
            ...
            <div className='space-y-6'>
              ...
              <div className='pb-4'>
                <p className='text-sm text-gray-500 mb-1'>
                  संदर्भ नोट / Reference Note
                </p>
                <p className='text-sm text-gray-800 leading-relaxed'>
                  कृपया भुगतान के Remarks में "ABSSD Donation - Your Name" लिखें
                  ताकि रसीद आसान हो सके।
                  <br />
                  Please add "ABSSD Donation - Your Name" in payment remarks for
            ...
            <div className='mt-6 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-600'>
              <p className='text-sm text-gray-700'>
                <span className='font-semibold'>नोट / Note:</span> कृपया दान
                करने के बाद रसीद के लिए हमसे संपर्क करें।
                <br />
        ...
        <div className='mt-12 max-w-4xl mx-auto'>
          <div className='bg-gradient-to-r from-orange-600 to-orange-500 rounded-2xl shadow-xl p-8 text-white text-center'>
            ...
            <p className='text-lg mb-6 opacity-90'>
              यदि आपके कोई प्रश्न हैं या रसीद की आवश्यकता है, तो कृपया हमसे
              संपर्क करें।
              <br />
