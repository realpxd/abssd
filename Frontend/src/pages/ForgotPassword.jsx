                ...
                <>
                  <div className='mb-6'>
                    <p className='text-sm text-gray-600 text-center'>
                      अपना ईमेल पता दर्ज करें और हम आपको पासवर्ड रीसेट लिंक
                      भेजेंगे।
                      <br />
                ...
                <div className='text-center py-4'>
                  ...
                  <div className='mb-6'>
                    ...
                    <p className='text-sm text-gray-600 mb-6'>
                      कृपया अपने ईमेल इनबॉक्स की जांच करें। लिंक 10 मिनट के लिए
                      वैध होगा।
                      <br />
                      Please check your email inbox. The link will be valid for
                      10 minutes.
                    </p>
                  </div>
