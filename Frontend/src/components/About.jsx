const About = () => {
  ...
  return (
    <section
      id='about'
      className='py-20 md:py-28 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative'
      style={{ marginTop: '-1px' }}
    >
          ...
          <div className='bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100'>
            ...
            <div className='bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 p-8 md:p-12 text-white relative overflow-hidden'>
              ...
              <div className='relative z-10 text-center'>
                <h3
                  className='text-3xl md:text-4xl font-bold mb-3 notranslate'
                  translate='no'
                >
            ...
            <div className='p-8 md:p-12'>
              <div className='space-y-6 text-lg text-gray-700 leading-relaxed'>
                <p>
                  <span className='inline-block bg-orange-100 text-orange-700 px-4 py-1 rounded-full text-base font-bold mr-2'>
                    वर्ष 2017 में स्थापित
                  </span>
                  <span className='notranslate' translate='no'>
                    अखिल भारतीय स्वच्छता सेवा दल ट्रस्ट
                  </span>{' '}
                  एक निःस्वार्थ सामाजिक संगठन है, जिसका उद्देश्य राष्ट्र को
                  स्वच्छ, सुंदर और प्रेरणादायी बनाना है।
                </p>
                <p>
                  इस संस्था की नींव{' '}
                  ...
                  से रखी — जहाँ से यह आंदोलन पूरे भारत में जनसेवा और स्वच्छता का
                  प्रतीक बन गया।
                </p>
                <div className='bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 border-l-4 border-orange-500'>
                  <p className='mb-4'>
                    ...
                    से संगठन लगातार खाटूधाम में:
                  </p>
                  <ul className='space-y-2 ml-4'>
                    <li className='flex items-start'>
                      <span className='text-orange-600 mr-2'>📍</span>
                      <span>
                        <strong>स्वच्छता अभियान</strong> - नियमित सफाई कार्यक्रम
                      </span>
                    </li>
                    <li className='flex items-start'>
                      <span className='text-orange-600 mr-2'>💧</span>
                      <span>
                        <strong>जलसेवा</strong> - वाटर कूलर स्थापना
                      </span>
                    </li>
                    <li className='flex items-start'>
                      <span className='text-orange-600 mr-2'>🚻</span>
                      <span>
                        <strong>शोचालय प्रबंधन</strong> - सफाई एवं जनसुविधा
                      </span>
                    </li>
                    <li className='flex items-start'>
                      <span className='text-orange-600 mr-2'>🎪</span>
                      <span>
                        <strong>मेले एवं एकादशी सेवा</strong> - विशेष अभियान
                      </span>
                    </li>
                  </ul>
                </div>
                <p>
                  <span className='font-semibold text-gray-900'>
                    हर माह की एकादशी सेवा
                  </span>{' '}
                  और{' '}
                  <span className='font-semibold text-orange-600'>
                    फाल्गुन मेले के दस दिवसीय विशेष सफाई अभियान
                  </span>{' '}
                  हमारी पहचान बन चुके हैं।
                </p>
                <p>
                  आज इस पवित्र अभियान से{' '}
                  <span className='inline-block bg-orange-600 text-white px-3 py-1 rounded-full font-bold'>
                    500+ स्वयंसेवक
                  </span>{' '}
                  जुड़े हैं, जो निःस्वार्थ भाव से समाज के लिए कार्य कर रहे हैं।
                </p>
              </div>
              ...
              <div className='mt-8 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-8 text-white shadow-xl'>
                <div className='text-center'>
                  ...
                  <p className='text-lg opacity-90 leading-relaxed'>
                    हम मानते हैं कि स्वच्छता केवल एक कार्य नहीं, बल्कि एक
                    संस्कृति है — और इस संस्कृति को जन-जन तक पहुँचाना ही हमारा
                    संकल्प है।
                  </p>
                </div>
              </div>
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-3xl shadow-2xl p-8 md:p-12 text-white relative overflow-hidden'>
            ...
            <div className='relative z-10 text-center'>
              ...
              <p
                className='text-3xl md:text-4xl font-bold mb-8 notranslate'
                translate='no'
              >
                श्री जीतू माली
              </p>
