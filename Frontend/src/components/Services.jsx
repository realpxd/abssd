  ...
  const mainServices = [
    {
      ...
      description:
        'खाटूधाम में नियमित स्वच्छता अभियान का संचालन करना। हर माह की एकादशी सेवा और फाल्गुन मेले के दस दिवसीय विशेष सफाई अभियान हमारी पहचान बन चुके हैं।',
      icon: '🧹',
    ...
    },
    {
      ...
      en: 'Water Service',
      description:
        'संस्थान ने खाटूधाम के प्रमुख स्थानों पर वाटर कूलर स्थापित किए हैं, ताकि देश-विदेश से आने वाले श्रद्धालुओं को स्वच्छ पेयजल मिल सके।',
      icon: '💧',
      bgColor: 'bg-blue-500',
    ...
    },
    {
      ...
      description:
        'शोचालयों की सफाई एवं जनसुविधा प्रबंधन। शोचालयों पर पेयजल एवं अन्य सुविधाएँ उपलब्ध करवाईं, ताकि श्रद्धालुओं को स्वच्छ वातावरण और सुविधा मिल सके।',
      icon: '🚻',
    ...
    },
    {
      ...
      description:
        'हर माह अनवरत दशमी शाम से द्वादशी सुबह तक एवं फाल्गुन मेले में अनवरत दस दिवसीय विशेष स्वछता सेवा अभियान',
      icon: '🎪',
    ...
    },
    {
      ...
      description:
        'पर्यावरण संरक्षण के लिए जागरूकता कार्यक्रमों का संचालन करना और लोगों को स्वच्छता के महत्व के बारे में शिक्षित करना।',
      icon: '🌿',
          ...
          <div className='bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-3xl shadow-2xl p-10 md:p-16 text-white relative overflow-hidden'>
            ...
            <div className='relative z-10 text-center'>
              ...
              <p className='text-lg md:text-xl leading-relaxed opacity-95 max-w-3xl mx-auto'>
                हम मानते हैं कि स्वच्छता केवल एक कार्य नहीं, बल्कि एक संस्कृति
                है — और इस संस्कृति को जन-जन तक पहुँचाना ही हमारा संकल्प है।
              </p>
            </div>
          </div>
        </div>
