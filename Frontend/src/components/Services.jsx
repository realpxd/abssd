  ...
  const mainServices = [
    {
      ...
      description: 'हर माह  अनवरत दशमी शाम से द्वादशी सुबह तक एवं फाल्गुन मेले में अनवरत दस दिवसीय विशेष स्वछता सेवा अभियान',
      icon: '🧹',
    ...
    },
    {
      ...
      description: 'शोचालयों की सफाई एवं जनसुविधा प्रबंधन। शोचालयों पर पेयजल एवं अन्य सुविधाएँ उपलब्ध करवाईं, ताकि श्रद्धालुओं को स्वच्छ वातावरण और सुविधा मिल सके।',
      icon: '🚻',
