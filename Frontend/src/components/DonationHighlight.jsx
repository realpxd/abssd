      ...
      <div className='container mx-auto px-4'>
        <div className='text-center max-w-3xl mx-auto mb-8 md:mb-10 space-y-3'>
          ...
          <p className='text-gray-600 text-sm md:text-base leading-relaxed'>
            दान का हर रूप (UPI या बैंक ट्रांसफर) हमारे स्वच्छता अभियानों और
            समुदाय सहायता को गति देता है। Every rupee fuels our cleanliness
            drives and community programs.
          </p>
        </div>
          ...
          <div className='grid md:grid-cols-2 gap-6 items-center'>
            <div className='space-y-3 text-center md:text-left'>
              ...
              <h3 className='text-2xl font-bold text-gray-900 leading-snug'>
                दान करें, बदलाव लाएँ / Donate to Drive Change
              </h3>
              <p className='text-gray-600 leading-relaxed text-sm md:text-base'>
                आपका छोटा सा योगदान स्वच्छता अभियानों, शिक्षा कार्यक्रमों और
                जरूरतमंदों की मदद में लगाया जाता है। Every contribution fuels
                our cleanliness drives and community support.
              </p>
            ...
            <div className='bg-orange-50 border border-orange-100 rounded-xl p-5 shadow-inner'>
              ...
              <div className='space-y-2 text-sm text-gray-700'>
                <div className='flex items-start gap-2'>
                  ...
                  <span>
                    खाता नाम / Account Name: Akhil Bhartiya Swachta Sewa Dal
                  </span>
                </div>
                <div className='flex items-start gap-2'>
                  <span className='text-orange-600 mt-0.5'>•</span>
