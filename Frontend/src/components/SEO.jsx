...
const SEO = ({
  ...
  const siteName =
    'अखिल भारतीय स्वच्छता सेवा दल ट्रस्ट | Akhil Bhartiya Swachhta Sewa Dal Trust | ABSSD';
  ...
  return (
    <Helmet>
      ...
      <meta
        ...
        content={
          description ||
          'अखिल भारतीय स्वच्छता सेवा दल ट्रस्ट - समर्पित सामाजिक संगठन जो स्वच्छता, सेवा और सामाजिक उत्थान के लिए कार्य करता है।'
        }
      />
      ...
      <script type='application/ld+json'>
        {JSON.stringify({
          ...
          description:
            'अखिल भारतीय स्वच्छता सेवा दल ट्रस्ट - सामाजिक सेवा संगठन',
          sameAs: [
