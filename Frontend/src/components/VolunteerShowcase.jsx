        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-12 md:mb-16'>
            ...
            <p className='text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-4'>
              Dedicated volunteers serving the nation with cleanliness and
              devotion
              <br />
              <span className='text-gray-700'>
                निरंतर सेवा, निःस्वार्थ समर्पण
              </span>
            </p>
            <p className='text-base md:text-lg text-gray-700 max-w-3xl mx-auto mt-4 leading-relaxed'>
              ...
              निःस्वार्थ भाव से राष्ट्र को स्वच्छ, सुंदर और प्रेरणादायी बनाने के
              लिए समर्पित हैं।
              <br />
              <span className='text-orange-600 font-semibold'>
                खाटूधाम में निरंतर सेवा
              </span>{' '}
              - हर माह की एकादशी सेवा और फाल्गुन मेले के विशेष अभियान।
            </p>
          </div>
